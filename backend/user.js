...
const { addEnv, delEnv, getEnvs, getEnvsCount, updateEnv, enableEnv } = require('./ql');
...
module.exports = class User {
  ...
  async updateRemark() {
    ...
    if ( this.remark.length > 20) {
      throw new UserError('这里是填写备注，不是CK。请确认', 260, 200);
    }
    ...
    throw new UserError('备注更新成功', 200, 200);
  }
